...
<table>
	...
	<thead>
		<tr>
			<th scope="col"><input name="ownAllCheckBtn" id="ownAllCheckBtn" class="" type="checkbox" onchange="checkAll('ownAllCheckBtn','ownCheckBtn')"/></th>
			<th scope="col">권한명</th>
	...
	<tbody>
		...
		<c:forEach items="${authList}" var="authVO" varStatus="st">
			<tr style="cursor: pointer; curosr: hand;" onclick="">
				<td><input type="checkbox" id="ownCheckBtn" name="ownCheckBtn${st.index }" value="${authVO.auth_id}"></td>

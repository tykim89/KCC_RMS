...
<script src="/js/rms/com/jquery.cookie.js"></script>
	...
	function idFind() {
	 ...
	 function setsave(name, value, expiredays) {
	       ...
	       // var today = new Date();
	        ...
	        $.cookie('admin_id', id, {expires: 7, path:'/', domain:'/KCC_RMS/rms/sys/loginPage.do', secure: true});
	...
	<div class="container">
        ...
        <header>
            ...
            <form class="log_form" id="log_form" method="post">
                ...
                <div class="toolbar">
                	<div><input name="saveid" id="saveid" class="int" type="checkbox" onclick="saveId();"/><label class="id_la">아이디 저장</label></div>
                    <div></div>

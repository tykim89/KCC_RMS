...
<script type="text/javaScript" language="javascript">
	function searchSubmit()
	{
		...
		var value = $("#searchKeyword").val();
		 $.post("<c:url value='/rms/sys/searchUser.do'/>", {searchCondition : key, searchKeyword : value}, function(html){
			$("#userForm").html(html);	
		});  
	...
	function fn_egov_link_page(pageNo){
		...
		document.searchForm.action = "<c:url value='/rms/recnews/recnewsBoardlist.do'/>";
                ...
                <div class="contents">
                	...
                	<form id="searchForm" action="" method="post">
                        <table>
                            ...
                            <tr>
                           		<td></td>
                           		<th scope="row"><select class="select" title="" name="searchCondition" id="searchCondition">
                              ...
                              <td colspan="3" class="btn">
                              	<input type="text" id="searchKeyword" name="searchKeyword" style="width:180px;"class="ipt_listIn" />

...
<script type="text/javascript">
	function dele(){
		...
		if(confirm('<spring:message code="common.delete.msg"/>')){				
		   	document.location.href = "./recnewsDeleteDetailBoard.do?rec_news_no=${vo.rec_news_no}&pageIndex=${pagingVO.pageIndex}";
	}
	}
	
	function modi(){		
		if(confirm('<spring:message code="common.update.msg"/>')){	
		document.location.href="./recnewsUpdateBoardForm.do?rec_news_no=${vo.rec_news_no}&pageIndex=${pagingVO.pageIndex}";
		}
	}
</script>
</head>

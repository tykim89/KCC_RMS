										...
										<table width="60%" class="box_02">
											<tbody>
												<tr class="odd">
													...
													<th style="text-align: center;">${appUserDetailMap.PSINFO01[0][0].app_item_name}</th>
													<td class="left">
														${appUserDetailMap.PSINFO01[0][0].app_item_content}
														<select style="width: 100px;" id="gender" name="PSINFO01|PSINFO007">
												...
												<tr class="even">
													<th style="text-align: center;"><c:out value="${appUserDetailMap.PSINFO01[0][1].app_item_name }"/></th>
													<td class="left">
														<input type="text" id="day" name="PSINFO01|PSINFO002"  class="ipt_st01" maxlength="10" value="<c:out value="${appUserDetailMap.PSINFO01[0][1].app_item_content }"></c:out>">
														&nbsp;예)2014-09-02				
																																				
													</td>
													<th style="text-align: center;">
														<c:out value="${appUserDetailMap.PSINFO01[0][2].app_item_name }"></c:out>
													</th>
													<td class="left"><input type="text" id="eng_name" name="PSINFO01|PSINFO001"  class="ipt_st01" value="${appUserDetailMap.PSINFO01[0][2].app_item_content }"></td>
...
<!-- 													<input type="text" id="zipcode1" name="zipcode1" style="width: 50px;">&nbsp;-&nbsp;<input type="text" name="zipcode2"  style="width: 50px;"> -->
													<input type="text" name="PSINFO01|PSINFO004"  class="ipt_st01" readonly="readonly"/>
<!-- 													<input type="button" value="검색" name="addrbtn" onclick="search()"/> -->
												...
												<tr class="odd">
													...
													<td class="left" colspan="3">
													<input type="text" name="PSINFO01|PSINFO005" readonly="readonly" style="width: 300px;" class="ipt_st01"/>
													<input type="text" name="PSINFO01|PSINFO006" style="width: 300px;"  class="ipt_st01"/>												
													</td>
												</tr>
												<tr class="even">
													<th style="text-align: center;">${PSINFO01[6].app_item_name}</th>
													<td class="left">
														<input type="text" id="phone_num" name="PSINFO01|PSINFO003"  class="ipt_st01" maxlength="13">
													</td>
													<th style="text-align: center;">${PSINFO01[7].app_item_name}</th>
													<td class="left">
														<input type="text"  id="tel_num" name="PSINFO01|PSINFO008"  class="ipt_st01" maxlength="13">
													</td>
												</tr>
												<tr class="odd">
										...
										<table width="60%" class="box_02">												
											<tbody>											
												<tr class="odd">
													...
													<td scope="col">
														<select id="miliSelect" name="BASINFO01|BASICINFO005" style="width: 100px;" >
															<option value="">선택</option>
													...
													<td><input type="text" id="miliKind" name="BASINFO01|BASICINFO006" class="ipt_st01"></td>
													<th style="text-align: center;">병과</th>
													<td><input type="text" id="" name="BASINFO01|BASICINFO007" class="ipt_st01"></td>
													<th style="text-align: center;">계급</th>
													<td><input type="text" id="" name="BASINFO01|BASICINFO008" class="ipt_st01"></td>
													<th style="text-align: center;">복무기간</th>
													<td class="btn">
						                                <input type="text" id="mili_start_day" name="BASINFO01|BASICINFO009" style="width:80px;" class="ipt_st01" maxlength="10"/>                                    
						                                    ~
						                                <input type="text" id="mili_end_day" name="BASINFO01|BASICINFO010" style="width:80px;" class="ipt_st01" maxlength="10"/>                                
						                            </td>
												</tr>
												<tr class="even">
													<th scope="col">보훈사항</th>
													<td scope="col">
														<select id="protectSelect" name="BASINFO01|BASICINFO001" style="width: 100px;" onchange="">
															<option value="">선택</option>
													...
													<td colspan="7" scope="col"><input type="text" id="" name="BASINFO01|BASICINFO002" class="ipt_st01"></td>
													
												</tr>
												<tr class="odd">
													<th scope="col">장애사항</th>
													<td scope="col">
														<select id="protectSelect" name="BASINFO01|BASICINFO003" style="width: 100px;" onchange="">
															<option value="">선택</option>
															<option value="미대상">미대상</option>
															<option value="대상">대상</option>
														</select>
													...
													<td colspan="7" scope="col"><input type="text" id="" name="BASINFO01|BASICINFO004" class="ipt_st01"></td>
										...
										<table  width="60%" class="box_02">
											...
											<tbody>
												...
												<tr class="odd">
													...
													<td style="text-align:center;"><input type="text" id="relation" name="FAM01|${j.app_item_no}" class="ipt_st01"></td>													
													</c:forEach>
												</tr>
											</tbody>
										</table>
...
<!-- 												</tr> -->
											<tbody>											
												<tr class="odd">
													...
													<td colspan="3"><input type="text" id="" name="STUDY01|STUDY001" class="ipt_st01">
												...
												<tr class="even">
													<th scope="col" style="text-align: center;"><c:out value="${STUDY01[2].app_item_name }"/></th>
														<td scope="col">
															<input type="text" id="" name="STUDY01|STUDY003" value="" class="ipt_st01" maxlength="7">
															~
															<input type="text" id="" name="STUDY01|STUDY004" value="" class="ipt_st01" maxlength="7">
															&nbsp;예)2014-09
														</td>
													<th scope="col" style="text-align: center;"><c:out value="${STUDY01[4].app_item_name }"/></th>
													<td scope="col">
 														<select id="" name="STUDY01|STUDY005" onchange="" style="width: 100px">
 															<option value="">선택</option>
												...
												<tr class="odd">
													...
													<td colspan="3">
														<select id="" name="STUDY01|STUDY006" style="width: 100px">
												...
												<tr class="even">
													...
													<td scope="col" colspan="3">
														<input type="text" id="" name="STUDY01|STUDY007" value="" class="ipt_st01">
													</td>
												</tr>
											</tbody>
										</table>
...
<!-- 												</tr> -->
												<tbody>												
													<tr class="odd">
														<th scope="col" style="text-align: center;" width="150px;"><c:out value="${STUDY02[0].app_item_name}"/></th>
														<td scope="col"><input type="text" id="" name="STUDY02|STUDY001" value="" class="ipt_st01"><c:out value="${STUDY02[0].app_item_content}"/></td>
													</tr>
													<tr class="even">
														<th scope="col" style="text-align: center;" width="150"><c:out value="${STUDY02[1].app_item_name}"/></th>
														<td scope="col"><input type="text" id="" name="STUDY02|STUDY002" class="ipt_st01" maxlength="7"><c:out value="${STUDY02[1].app_item_content}"/>
															<select id="" name="STUDY02|STUDY004" style="width: 100px;" onchange="">
																<option value="">선택</option>
																<option value="entrance">입학</option>
																<option value="transfer">편입</option>
															</select>
															~
															<input type="text" id="" name="STUDY02|STUDY003" class="ipt_st01" maxlength="7" >
															<select id="" name="STUDY02|STUDY005" class="select" title="졸업구분" style="width: 100px" onchange="">
																<option value="">선택</option>
																<option value="졸업">졸업</option>
																<option value="졸업예정">졸업예정</option>
																<option value="중퇴">중퇴</option>
													...
													<tr class="odd">
														...
														<td scope="col" width="400">
															<select id="" name="STUDY02|STUDY006" class="select" title="전공구분" style="width: 100px" onchange="">
																<option value="전문 학사">(전문)학사</option>
																<option value="학사">학사</option>
																<option value="석사">석사</option>
																<option value="박사">박사</option>
															</select>
															<input type="text" id="" name="STUDY02|STUDY007" value="" class="ipt_st01">
														</td>
														<th scope="col" style="text-align: center;" width="150">학점</th>
														<td scope="col">
															<input type="text" id="" name="STUDY02|STUDY010" class="ipt_st01">
															<select id="" name="STUDY02|STUDY011" class="select" title="총점" style="width: 100px;" onchange="">
													...
													<tr class="odd">
														<td colspan="3" scope="col">
															<select id="" name="STUDY02|STUDY008" class="select" title="전공구분" style="width: 100px;" onchange="">
																<option value="복수전공">복수전공</option>
																<option value="부전공">부전공</option>
															</select>
															<input type="text" id="" name="STUDY02|STUDY009" value="" class="ipt_st01">
														</td>
													...
													<tr class="even">
														...
														<td colspan="3" scope="col">
															<input type="text" id="" name="STUDY02|STUDY012" class="ipt_st01">
														</td>
													</tr>
												</tbody>
											</table>
...
<!-- 										</tr> -->								
										<tr class="odd">
												...
												<td scope="col">
													<input type="text" id="" name="LANG01|LANG001" value="" class="ipt_st01"> 
												</td>
												<th style="text-align: center;">점수</th>
												<td scope="col">
													<input type="text" id="" name="LANG01|LANG002" value="" class="ipt_st01">
												</td>
												<th style="text-align: center;">등급</th>
												<td scope="col">
													<input type="text" id="" name="LANG01|LANG003" value="" class="ipt_st01">
												</td>
										</tr>
										<tr class="even">
											<th style="text-align: center;">발급기관</th>
											<td scope="col"><input type="text" id="" name="LANG01|LANG004" class="ipt_st01"></td>
											<th style="text-align: center;">취득일자</th>
											<td scope="col">
												<input type="text" id="" name="LANG01|LANG005" value="" class="ipt_st01" maxlength="10">
												&nbsp;예)2014-09-02
											</td>
										</tr>
								</table>
...
<!-- 										</tr> -->
										...
										<td scope="col">
											<input type="text" id="" name="CERTI01|CERTI001" value="" class="ipt_st01">
										</td>
									</tr>
									<tr class="even">
										<th style="text-align: center;">발급기관</th>
										<td><input type="text" id="" name="CERTI01|CERTI002" value="" class="ipt_st01"></td>
										<th style="text-align: center;">취득일자</th>
										<td>
											<input type="text" id="" name="CERTI01|CERTI003" value="" class="ipt_st01" maxlength="10">
											&nbsp;예)2014-09-02
										</td>
									</tr>
								</table>
...
<!-- 									</tr> -->
								<tbody>
									...
									<tr class="odd">
										...
										<td colspan="3" scope="col">
											<input type="text" id="" name="EDU01|EDU001" value="" class="ipt_st01">
										</td>
									</tr>
									<tr class="even">
										<th style="text-align: center;">과목명</th>
										<td><input type="text" id="" name="EDU01|EDU002" value="" class="ipt_st01"></td>
										<th style="text-align: center;">교육기간</th>
										<td>
											<input type="text" id="" name="EDU01|EDU003" value="" class="ipt_st01" maxlength="10">
											~
											<input type="text" id="" name="EDU01|EDU004" value="" class="ipt_st01" maxlength="10">
										&nbsp;예)2014-09-02
										</td>
									</tr>
									<tr class="odd">
										...
										<td colspan="3" scope="col">
											<input type="text" id="" name="EDU01|EDU005" value="" style="width: 500px;" class="ipt_st01">
										</td>
									</tr>
								</tbody>
							</table>
...
<!-- 									</tr> -->
								<tbody>
									...
									<tr class="odd">
										...
										<td scope="col">
											<input type="text" id="" name="EXP01|EXP001" value="" class="ipt_st01">
										</td>
										<th style="text-align: center;">체류기간</th>
										<td scope="col">
											<input type="text" id="" name="EXP01|EXP002" value="" class="ipt_st01" maxlength="10">
											~
											<input type="text" id="" name="EXP01|EXP003" value="" class="ipt_st01" maxlength="10">
											&nbsp;예)2014-09-02
										</td>
									</tr>
									<tr class="even">
										...
										<td colspan="3" scope="col">
											<input type="text" id="" name="EXP01|EXP004" value="" style="width: 500px;" class="ipt_st01">
										</td>
									</tr>
								</tbody>
							</table>
...
<%-- 								<h3><c:out value="${fil.app_list_code_name }"></c:out> </h3> --%>
								...
								<tbody>
									...
									<tr class="odd">
										...
										<td colspan="3" scope="col">
											<input type="text" id="" name="AWARD01|AWARD001" value="" class="ipt_st01">
										</td>
									</tr>
									<tr class="even">
										<th style="text-align: center;">수여기관</th>
										<td scope="col">
											<input type="text" id="" name="AWARD01|AWARD002" value="" class="ipt_st01">
										</td>
										<th style="text-align: center;">수상날짜</th>
										<td>
											<input type="text" id="" name="AWARD01|AWARD003" value="" class="ipt_st01" maxlength="10">
											&nbsp;예)2014-09-02
										</td>
									</tr>
								</tbody>
...
<!-- 									</tr> -->
								<tbody>								
									<tr class="odd">
										...
										<td colspan="3" scope="col">
											<input type="text" id="" name="ACTIV01|ACTIV001" value="" class="ipt_st01">
										</td>
									</tr>
									<tr class="even">
										<th style="text-align: center;">봉사기관/장소</th>
										<td scope="col">
											<input type="text" id="" name="ACTIV01|ACTIV002" value="" class="ipt_st01">
										</td>
										<th style="text-align: center;">활동기간</th>
										<td>
											<input type="text" id="" name="ACTIV01|ACTIV003" value="" class="ipt_st01" maxlength="10"> 
											~
											<input type="text" id="" name="ACTIV01|ACTIV004" value="" class="ipt_st01" maxlength="10"> 	
											&nbsp;예)2014-09-02									
										</td>
									</tr>
									<tr class="odd">
										...
										<td colspan="3" scope="col">
											<input type="text" id="" name="ACTIV01|ACTIV005" value="" style="width: 500px;" class="ipt_st01">
										</td>
									</tr>
								</tbody>
							</table>
...
<!-- 										</tr> -->
								<tbody>								
									<tr class="odd">
										...
										<td colspan="3" scope="col">
											<input type="text" id="" name="CAREER01|CAREER001" value="" class="ipt_st01">
										</td>
									</tr>
									<tr class="even">
										<th style="text-align: center;">고용형태</th>
										<td scope="col">
											<input type="text" id="" name="CAREER01|CAREER002" value="" class="ipt_st01">
										</td>
										<th style="text-align: center;">이직사유</th>
										<td>
											<input type="text" id="" name="CAREER01|CAREER003" value="" class="ipt_st01">
										</td>
									</tr>
									<tr class="odd">
										<th style="text-align: center;">근무기간</th>
										<td colspan="3" scope="col">
											<input type="text" id="" name="CAREER01|CAREER004" value="" class="ipt_st01" maxlength="10">
											~
											<input type="text" id="" name="CAREER01|CAREER005" value="" class="ipt_st01" maxlength="10">
											&nbsp;예)2014-09-02
										</td>
									</tr>
									<tr class="even">
										...
										<td scope="col">
											<input type="text" id="" name="CAREER01|CAREER006" value="" class="ipt_st01"> 
										</td>
										<th style="text-align: center;">직급</th>
										<td>
											<input type="text" id="" name="CAREER01|CAREER007" value="" class="ipt_st01">
										</td>
									</tr>
									<tr class="odd">
										<th style="text-align: center;">연봉</th>
										<td scope="col">
											<input type="text" id="" name="CAREER01|CAREER008" value="" class="ipt_st01">&nbsp;만원
										</td>
										<th style="text-align: center;">희망연봉</th>
										<td>
											<input type="text" id="" name="CAREER01|CAREER009" value="" class="ipt_st01">&nbsp;만원
										</td>
									</tr>
									<tr class="odd">
										<th style="text-align: center;">담당업무</th>
										<td colspan="3" scope="col">
											<input type="text" id="" name="CAREER01|CAREER010" value="" class="ipt_st01">
										</td>
									</tr>
									<tr class="even">
									...
									<tr class="odd">
										<td colspan="3" scope="col">
											<input type="text" id="" name="CAREER01|CAREER011" value="" style="width: 500px;" class="ipt_st01">
										</td>
									</tr>
									<tr>
...
<%-- 								<h3><c:out value="${fil.app_list_code_name }"></c:out> </h3> --%>
								...
								<tbody>
									<tr class="odd">
										...
										<td scope="col">
											<textarea type="text" name="RESUME01|RESUME001" style="width:900px; height:200px;"></textarea>
										</td>
									</tr>
								</tbody>
							</table>

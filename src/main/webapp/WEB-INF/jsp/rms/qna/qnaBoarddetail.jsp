...
<script type="text/javascript">
	...
	//수정 폼 이동시, 기존 selectbox에서 선택한 값 유지
	$(document).ready(function(){
		
		var qna_type_code = "${vo.qna_type_code}";
		$("#qna_type_code").val(qna_type_code);
...
// 		alert(page_num);
		document.location.href="/KCC_RMS/rms/qna/qnaBoardlist.do?pageIndex=${vo.pageIndex}";
	}
				...
				<div class="pager">
					<div class="paging_right">
						...
						<span class="btn-pack btn-type_4"> 
							<a onclick="document.location.href='./qnaDeleteDetailBoard.do?qna_quest_no=${vo.qna_quest_no}&pageIndex=${vo.pageIndex}'">

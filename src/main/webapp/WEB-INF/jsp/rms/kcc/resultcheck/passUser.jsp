...
<!-- 						</table> -->
						...
						<table border="0" cellspacing="0" class="box_03" style="padding-left: 50px;" >
						<input type="hidden" name="ins_gubun" value="">
						<input type="hidden" name="PK" value="291">
<!-- 							<tr><td height="30" colspan=""></td></tr> -->
							<tr>
<!-- 								<td style="padding-left:43px" width="64"><img src="/KCC_RMS/images/rms/kcc/img_successful_ann01.gif"></td> -->
								<td><img src="/KCC_RMS/images/rms/kcc/img_successful_ann01.gif"></td>
							</tr>
							<tr><td height="30" colspan="2"></td></tr>
							<tr>
<%-- 								<td style="padding-left:21px"><textarea rows="13" cols="70">${content.rec_sch_content}</textarea></td> --%>
									<td><textarea rows="13" cols="70">${content.rec_sch_content}</textarea></td>
							</tr>

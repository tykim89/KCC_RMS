...
public class DefaultVO implements Serializable{
	...
	public String toString() {
		return "DefaultVO [searchCondition=" + searchCondition
				...
				+ ", recordCountPerPage=" + recordCountPerPage + ", rec_year="
				+ rec_year + ", career_div_code=" + career_div_code
				+ ", state_code=" + state_code + ", recFieldList="
				+ recFieldList + ", rec_field_name=" + rec_field_name + "]";
	}
